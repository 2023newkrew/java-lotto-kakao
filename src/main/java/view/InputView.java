...
public class InputView {
    ...
    private static void validatePurchaseBudget(int purchaseBudget) {
        if (purchaseBudget == 0)
    ...
    public static List<LottoTicket> inputManualLottoNumbers(int purchaseAmount) {
    ...
    private static int inputManualLottoCount(int purchaseAmount) {
    ...
    private static List<LottoNumber> inputWinningLottoNumbers() {
        System.out.println("\n지난 주 당첨 번호를 입력해 주세요.");
        return inputNumbers();
    }
