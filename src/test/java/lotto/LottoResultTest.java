...
public class LottoResultTest {
    ...
    void lotto_result_match_test() {
        assertEquals(LottoResult.match(new MatchedResult(3, true)), LottoResult.THREE_NUMBERS_MATCHED_AND_BONUS_MATCHED);
    ...
    void lotto_result_prize_money_test() {
        assertEquals(LottoResult.match(new MatchedResult(2, true)).getPrizeMoney(), 5000);
    }
}
