...
class LottoBallNumberTest {
    ...
    void 정상_실행_1에서_45_사이일_때는(int num){
        assertThatCode(()->{
            LottoBallNumber lottoBallNumber = LottoBallNumber.get(num);
    ...
    @Test
    void 비교_가능_해야_함(){
        LottoBallNumber ballNum1 = LottoBallNumber.get(1);
        LottoBallNumber ballNum2 = LottoBallNumber.get(5);
    ...
    void toString_정상작동(int val){
        LottoBallNumber ballNum1 = LottoBallNumber.get(val);
