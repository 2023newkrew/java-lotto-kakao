...
public class WinningLottoTest {
    ...
    void getResultReturnNONETest(String input) {
        Lotto lotto = LottoFactory.getLotto(new ManualLottoGenerator(input));
    ...
    void getResultReturnTRHEETest() {
        Lotto lotto = LottoFactory.getLotto(new ManualLottoGenerator("1, 2, 3, 7, 8, 9"));
    ...
    void getResultReturnFOURTest() {
        Lotto lotto = LottoFactory.getLotto(new ManualLottoGenerator("1, 2, 3, 4, 8, 9"));
    ...
    void getResultReturnFIVETest() {
        Lotto lotto = LottoFactory.getLotto(new ManualLottoGenerator("1, 2, 3, 4, 5, 9"));
    ...
    void getResultReturnFIVEBONUSTest() {
        Lotto lotto = LottoFactory.getLotto(new ManualLottoGenerator("1, 2, 3, 4, 5, 7"));
    ...
    @Test
    void isBonusTest(){
        Lotto lottoWithBonusNumber = LottoFactory.getLotto(new ManualLottoGenerator("7, 8, 9, 10, 11, 12"));
    ...
    @Test
    void isNotBonusTest(){
        Lotto lottoWithoutBonusNumber = LottoFactory.getLotto(new ManualLottoGenerator("8, 9, 10, 11, 12, 13"));
